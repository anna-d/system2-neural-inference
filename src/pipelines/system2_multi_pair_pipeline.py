...
def load_model(weights, num_classes, device):
...
def main():
    ...
    baseline = load_model(args.baseline_weights, 10, device)

    pair1 = load_model(args.pair1_weights, 2, device)
    pair2 = load_model(args.pair2_weights, 2, device)
